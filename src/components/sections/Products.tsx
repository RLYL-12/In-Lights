...
import { Lightbulb, Lamp, LampCeiling, LampFloor, ArrowUpLeft, Check } from "lucide-react";
...
const PRODUCTS = [
  ...
  },
  {
    ...
    name: "أضواء الأرضية",
    tag: "إضاءة خارجية",
    desc: "حلول إضاءة أرضية للحدائق والمسارات",
        ...
        <StaggerGroup className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {PRODUCTS.map((p) => (
            <StaggerChild key={p.name}>
              <div className="group relative h-full overflow-hidden rounded-3xl border border-navy/10 bg-white shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-glow-navy">
                {/* Arch visual top */}
                ...
                {/* Content */}
                <div className="p-6">
                  <h3 className="mb-1 font-display text-xl font-bold text-navy">
                    {p.name}
                  </h3>
