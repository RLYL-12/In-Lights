...
const TESTIMONIALS = [
  {
    ...
    company: "الرياض",
    text: "تجربة استثنائية مع فريق إن لايتس. حوّلوا منزلي إلى تحفة فنية بإضاءةٍ راقية. الاحترافية والإتقان في أعلى مستوياتهما.",
    rating: 5,
  },
  {
    name: "سارة المطيري",
    role: "مديرة تسويق",
    company: "شركة أركان",
    text: "نفّذوا إضاءة مكتبنا بطريقة عكست هويتنا البصرية بدقة. النتيجة فاقت توقعاتنا وأضفت أجواءً مُلهمة على مساحة العمل.",
    rating: 5,
  },
  {
    name: "خالد الدوسري",
    role: "مستثمر عقاري",
    company: "جدة",
    text: "أفضل شركة إضاءة تعاملت معها. الالتزام بالمواعيد، جودة المنتجات، والتصاميم المبتكرة جعلتهم خياري الأول لكل مشاريعي.",
    rating: 5,
  },
  {
    name: "نورة القحطاني",
    role: "مهندسة معمارية",
    company: "مكتب الإعمار",
    text: "كنموذج رائع للشراكة المهنية. يفهمون رؤية المصمم ويُترجمونها لإضاءةٍ تُبرز جمال التصميم المعماري بامتياز.",
    rating: 5,
  },
];
    ...
    <section id="testimonials" className="relative overflow-hidden bg-navy py-20 sm:py-28">
      ...
      <div className="relative z-10 mx-auto mb-20 max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal direction="up" className="mb-6 text-center">
          <span className="font-arabic text-sm font-medium text-gold-light">
            موثوق به من قِبل نخبة من الشركاء
          </span>
        </Reveal>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="ثقة عملائنا هي نورنا الذي نهتدي به. إليكم بعض كلماتهم التي تُشرفنا."
        />
