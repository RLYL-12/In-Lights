...
const POSTS = [
  {
    title: "كيف تنظم مؤتمراً ناجحاً؟",
    excerpt:
      "دليل شامل لتنظيم المؤتمرات من التخطيط إلى التنفيذ — تعرّف على أفضل الممارسات لضمان مؤتمر يُشهد له بالنجاح.",
    category: "نصائح",
    date: "١٥ يونيو ٢٠٢٤",
    readTime: "٦ دقائق",
  ...
  {
    title: "أحدث تقنيات شاشات LED",
    excerpt:
      "تعرّف على أحدث تقنيات شاشات LED وكيف تُحسّن تجربة الحضور في فعالياتكم.",
    category: "تقنية",
    date: "٨ يونيو ٢٠٢٤",
    readTime: "٤ دقائق",
  ...
  {
    title: "أفكار مبتكرة للفعاليات",
    excerpt:
      "أفكار إبداعية ومبتكرة لجعل فعاليتك تجربة لا تُنسى تُبهر حضورك.",
    category: "إبداع",
    date: "١ يونيو ٢٠٢٤",
    readTime: "٥ دقائق",
  ...
  {
    title: "إدارة الحضور رقمياً",
    excerpt:
      "كيف تُسهّل حلول إدارة الحضور الرقمية تنظيم فعالياتك وتُحسّن تجربة الضيوف.",
    category: "تقنية",
    date: "٢٥ مايو ٢٠٢٤",
    readTime: "٧ دقائق",
...
const CATEGORIES = ["الكل", "نصائح", "تقنية", "إبداع"];
    ...
    <section id="blog" className="relative overflow-hidden bg-background py-20 sm:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="مقالات ودروس حول عالم الفعاليات، أحدث التقنيات، ونصائح لتنظيم فعاليات ناجحة."
        />
